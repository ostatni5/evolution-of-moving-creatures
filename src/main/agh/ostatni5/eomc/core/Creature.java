...
public class Creature implements IMapElement {
    ...
    public Creature(Creature creature) {
        ...
        id = new Id(creature.id);
    }

    public Creature(WorldMap _map, Vector2d _position, int _startEnergy) {
    ...
    public Creature(WorldMap _map, Vector2d _position, int _startEnergy, int _energyValue, Genotype _genotype, Creature creature1, Creature creature2) {
        position = new Vector2d(_position);
        worldMap = _map;
    ...
    public Creature(WorldMap _map, Vector2d _position, int _startEnergy, int _energyValue, Genotype _genotype, Creature creature1, Creature creature2, int iteration) {
